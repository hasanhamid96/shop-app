...
class _AuthCardState extends State<AuthCard> with SingleTickerProviderStateMixin{
  ...
  void initState(){
    ...
    _offsetAnimation=Tween<Offset>(begin:Offset(0,-1.5),end:Offset(0,0) ).animate(
...
//      Navigator.of(context).pushNamed(ProductScreen.routeName);
    ...
    on HttpExecption catch(error){
      ...
      if(error.toString().contains('EMAIL_EXIST'))
        errorMessage='email exist!!, please enter another email';
      else if(error.toString().contains('INVALID_EMAIL'))
        errorMessage='email NOT valid!!, please enter a VALID email';
      else if(error.toString().contains('WEAK_PASSWORD'))
        errorMessage='please enter a strong password';
      else if(error.toString().contains('INVALID_PASSWORD'))
        errorMessage='PASSWORD NOT VALID!!, please enter a VALID PASSWORD';
      else if(error.toString().contains('EMAIL_NOT_FOUND'))
        errorMessage='email NOT found!!, please enter a new email';
